...
(function() {
    ...
    function getImageData(){
        let pool = document.getElementsByClassName("status-notice")[2];
        if(pool){
            try{
                var poolName = pool.children[0].children[0].children[2].textContent + pool.children[0].children[0].children[1].textContent;
            }
            catch(e){
                console.log("未知错误！");
                console.log(e)
